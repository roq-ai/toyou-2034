...
import { getCompanySkillById } from 'apiSdk/company-skills';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Company Skill Detail View
          </Text>
          {hasAccess('company_skill', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/company-skills/edit/${data?.id}`} passHref legacyBehavior>
              <Button
